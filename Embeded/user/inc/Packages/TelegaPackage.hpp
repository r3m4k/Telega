...
#ifndef __TELEGA_PACKAGE_HPP
#define __TELEGA_PACKAGE_HPP
...
namespace STM_CppLib{
    ...
    private:
        ...
        //     "Incorrect length of data inside the Telega package"
        // );

    public:
        TelegaPackage() = delete;
        TelegaPackage(TriaxialData* _acc_data_ptr, TriaxialData* _gyro_data_ptr, TriaxialData* _mag_data_ptr):
