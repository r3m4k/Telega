...
#define DISABLE_INTERRUPTS()  __disable_irq()  /*CO_interruptStatus = INTDisableInterrupts()*/
#define ENABLE_INTERRUPTS()   __enable_irq() /* INTRestoreInterrupts(CO_interruptStatus)*/
